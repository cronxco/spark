...
<div>
                        ...
                        <div class="border border-base-300 rounded-lg p-3 bg-base-100 group">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <x-dropdown>
                                    ...
                                    <x-menu-item title="{{ __('Configure') }}" link="{{ route('integrations.configure', $integration['id']) }}" icon="o-cog-6-tooth" />
                                    <x-menu-item title="{{ __('View Details') }}" link="{{ route('integrations.details', $integration['id']) }}" icon="o-eye" />
                                    <x-menu-item
                                        title="{{ __('Delete') }}"
                                        icon="o-trash"
    ...
    <div class="text-center py-12">
        <x-icon name="o-magnifying-glass" class="w-16 h-16 mx-auto text-base-content/70 mb-4" />
