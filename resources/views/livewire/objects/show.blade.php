...
new class extends Component {
    ...
    public function getObjectIcon($type, $concept)
    {
    $icons = [
        'user' => 'o-user',
        ...
        'table' => 'o-table-cells',
        'record' => 'o-document',
        'row' => 'o-table-cells-row',
        'column' => 'o-table-cells-column',
        ...
        'goal' => 'o-flag',
        'target' => 'o-bullseye',
        'objective' => 'o-bullseye',
        'purpose' => 'o-bullseye',
        'intention' => 'o-bullseye',
        'motivation' => 'o-bullseye',
