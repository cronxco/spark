        ...
        <div class="flex flex-col lg:flex-row gap-4 lg:gap-6">
            ...
            <div class="flex-1 space-y-4 lg:space-y-6">
                    ...
                    <div class="flex flex-col sm:flex-row items-start gap-4 lg:gap-6">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex flex-wrap items-center gap-3 mb-4">
                                ...
                                <div class="flex items-center gap-2">
                                    <x-icon name="o-arrow-down-tray" class="w-4 h-4 text-base-content/60" />
                ...
                @if ($this->media->model)
                    <x-card class="bg-base-100 shadow">
                        <h3 class="text-lg font-semibold text-base-content mb-4 flex items-center gap-2">
                            <x-icon name="o-link" class="w-5 h-5 text-warning" />
                ...
                @if ($conversions->isNotEmpty())
                    <x-card class="bg-base-100 shadow">
                        <h3 class="text-lg font-semibold text-base-content mb-4 flex items-center gap-2">
                            <x-icon name="o-photo" class="w-5 h-5 text-success" />
