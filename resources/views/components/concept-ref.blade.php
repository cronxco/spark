@props(['concept', 'service' => null, 'variant' => 'badge', 'href' => null])

@php
use App\Integrations\PluginRegistry;

// Handle null/empty concept gracefully
if (!$concept) {
    return;
}
...
// Concept display
$conceptLabel = Str::headline($concept);

// Generate href if not provided - link to filtered admin objects
$defaultHref = '/admin/objects?concept=' . urlencode($concept);
$linkHref = $href ?? $defaultHref;

// Get object count for this concept
$objectCount = \App\Models\EventObject::where('concept', $concept)->count();

// Base ID for this popover
$popoverBaseId = 'concept-ref-' . md5($concept . ($service ?? ''));
@endphp
            ...
            <div class="card-body p-4 gap-3">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="badge badge-ghost badge-xs mt-1">Concept</div>
                    </div>
                </div>
                ...
                @php
                    $recentObjects = \App\Models\EventObject::where('concept', $concept)
                        ->orderBy('time', 'desc')
                        ->limit(3)
                        ->get();
                @endphp
