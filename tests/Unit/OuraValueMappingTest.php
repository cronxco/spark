...
{
    public function test_stress_level_mapping_for_storage(): void
    {
    ...
    public function test_stress_level_mapping_for_display(): void
    {
        $plugin = new OuraPlugin();
    ...
    public function test_unknown_mapping_key_returns_null_for_storage(): void
    {
        $plugin = new OuraPlugin();
    ...
    public function test_unknown_mapping_key_returns_no_data_for_display(): void
    {
        $plugin = new OuraPlugin();
    ...
    public function test_unknown_numeric_value_returns_unknown_for_display(): void
    {
        $plugin = new OuraPlugin();
    ...
    public function test_resilience_level_mapping_for_storage(): void
    {
        $plugin = new OuraPlugin();
    ...
    public function test_resilience_level_mapping_for_display(): void
    {
        $plugin = new OuraPlugin();
