...
class OutlinePullRecentDayNotesTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function job_can_be_instantiated(): void
    {
        ...
        $job = new OutlinePullRecentDayNotes($integration);

        $this->assertInstanceOf(OutlinePullRecentDayNotes::class, $job);
    }
    ...
    public function returns_correct_service_name_and_job_type(): void
    {
        ...
        $this->assertSame('pull_recent_daynotes', $jobTypeMethod->invoke($job));
    }
