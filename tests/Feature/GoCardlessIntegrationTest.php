...
class GoCardlessIntegrationTest extends TestCase
{
    ...
    public function test_plugin_metadata_and_service_type(): void
    {
    ...
    public function test_onboarding_institution_selection_route_exists_and_sets_session(): void
    {
        /** @var User $user */
    ...
    public function test_bank_selection_page_loads(): void
    {
        /** @var User $user */
        $user = User::factory()->create();
        $this->actingAs($user);
    ...
    public function test_bank_selection_page_shows_error_when_no_banks_available(): void
    {
        /** @var User $user */
        $user = User::factory()->create();
        $this->actingAs($user);
    ...
    public function test_oauth_flow_uses_selected_institution_and_redirects(): void
    {
        /** @var User $user */
        $user = User::factory()->create();
        $this->actingAs($user);
    ...
    public function test_initialization_redirects_to_bank_selection(): void
    {
        /** @var User $user */
        $user = User::factory()->create();
        $this->actingAs($user);
    ...
    public function test_plugin_constructor_validates_credentials(): void
    {
    ...
    public function test_plugin_constructor_allows_empty_credentials_in_testing(): void
    {
