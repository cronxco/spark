            ...
            if ($isFetchQuery) {
                $results->push(
                    SpotlightResult::make()
                        ...
                        ->setGroup('navigation')
                        ->setPriority(1)
                        ->setAction('jump_to', ['path' => route('bookmarks.fetch')])
                );
            }
            ...
            if ($isFetchQuery && (blank($query) || str_contains($lowerQuery, 'discover'))) {
                $results->push(
                    SpotlightResult::make()
                        ...
                        ->setGroup('navigation')
                        ->setPriority(2)
                        ->setAction('jump_to', ['path' => route('bookmarks.fetch') . '?tab=discovery'])
                );
            }
            ...
            if ($isFetchQuery && (blank($query) || str_contains($lowerQuery, 'cookie'))) {
                $results->push(
                    SpotlightResult::make()
                        ...
                        ->setGroup('navigation')
                        ->setPriority(3)
                        ->setAction('jump_to', ['path' => route('bookmarks.fetch') . '?tab=cookies'])
                );
            }
            ...
            if ($isFetchQuery && (blank($query) || str_contains($lowerQuery, 'playwright') || str_contains($lowerQuery, 'browser'))) {
                $results->push(
                    SpotlightResult::make()
                        ...
                        ->setGroup('navigation')
                        ->setPriority(4)
                        ->setAction('jump_to', ['path' => route('bookmarks.fetch') . '?tab=playwright'])
                );
            }
            ...
            if ($isFetchQuery && (blank($query) || str_contains($lowerQuery, 'api'))) {
                $results->push(
                    SpotlightResult::make()
                        ...
                        ->setGroup('navigation')
                        ->setPriority(5)
                        ->setAction('jump_to', ['path' => route('bookmarks.fetch') . '?tab=api'])
                );
            }
