    ...
    public static function getActionTypes(): array
    {
        return [
            ...
            'pot_transfer_to' => [
                ...
                'description' => 'Money was transferred to a pot',
                'display_with_object' => true,
                'value_unit' => 'GBP',
                'hidden' => false,
            ],
            'pot_withdrawal_from' => [
                ...
                'description' => 'Money was withdrawn from a pot',
                'display_with_object' => true,
                'value_unit' => 'GBP',
                'hidden' => false,
            ],
            'direct_credit_from' => [
                ...
                'description' => 'Money was credited to the account',
                'display_with_object' => true,
                'value_unit' => 'GBP',
                'hidden' => false,
            ],
            'direct_debit_to' => [
                ...
                'description' => 'Money was debited from the account',
                'display_with_object' => true,
                'value_unit' => 'GBP',
                'hidden' => false,
            ],
            'card_payment_to' => [
                ...
                'description' => 'Payment was made with a card',
                'display_with_object' => true,
                'value_unit' => 'GBP',
                'hidden' => false,
            ],
            'card_refund_from' => [
                ...
                'description' => 'Refund was received from a card payment',
                'display_with_object' => true,
                'value_unit' => 'GBP',
                'hidden' => false,
            ],
            'bank_transfer_to' => [
                'icon' => 'o-arrow-up',
                'display_name' => 'Bank Transfer Out',
                'description' => 'Money was transferred out of the account',
                'display_with_object' => true,
                'value_unit' => 'GBP',
                'hidden' => false,
            ],
            'bank_transfer_from' => [
                'icon' => 'o-arrow-down',
                'display_name' => 'Bank Transfer In',
                'description' => 'Money was transferred into the account',
                'display_with_object' => true,
                'value_unit' => 'GBP',
                'hidden' => false,
            ],
            'salary_received_from' => [
                ...
                'description' => 'Salary was received',
                'display_with_object' => true,
                'value_unit' => 'GBP',
                'hidden' => false,
            ],
            'other_credit_from' => [
                ...
                'description' => 'Other money was credited to the account',
                'display_with_object' => true,
                'value_unit' => 'GBP',
                'hidden' => false,
            ],
            ...
            'monzo_flex_payment' => [
                ...
                'description' => 'Payment was made using Monzo Flex',
                'display_with_object' => true,
                'value_unit' => 'GBP',
                'hidden' => false,
            ],
            'monzo_flex_loan' => [
                ...
                'description' => 'A loan was taken out using Monzo Flex',
                'display_with_object' => true,
                'value_unit' => 'GBP',
                'hidden' => false,
            ],
            'monzo_me_from' => [
                'icon' => 'o-arrow-up',
                'display_name' => 'Monzo Me Payment',
                'description' => 'Payment was made to another Monzo user',
                'display_with_object' => true,
                'value_unit' => 'GBP',
                'hidden' => false,
            ],
            'monzo_me_to' => [
                ...
                'description' => 'Payment was received from another Monzo user',
                'display_with_object' => true,
                'value_unit' => 'GBP',
                'hidden' => false,
            ],
